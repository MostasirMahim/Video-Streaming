...
import { createGroup, deleteGroup, getGroupById, getGroupMessages, getUserGroups, sendGroupMessage } from '../controllers/group.controller.js';
...
router.get('/:groupId',protectedRoutes,getGroupById);
